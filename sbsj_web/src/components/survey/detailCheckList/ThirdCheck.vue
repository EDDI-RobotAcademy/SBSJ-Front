<template>
    ...
    <div class="container">
      <div class="col-auto">
        <div class="container">
          <h1 style="color:#5B1A7C;">PICK YOUR ENERGY</h1>
          ...
          <form style="padding-inline: 30%;">
              ...
              <div>
                <div style="font-size: xx-large;">
                    <div style="margin-top:10%; height:100%; width:100%; display:flex; justify-content:center; align-items:center; font-weight: 100;">
                        <p style="margin-top:3%; font-weight: bold; ">흡연</p>
                        을 하시나요?
                    </div>
                </div>
              </div>
              ...
              <div style="padding-inline: 30%; margin-top:8%; font-size: larger; display:flex; justify-content:center; align-items:center;">
                <div class="form-group">
                  <div>
                    <button class="btn btn-primary" type="button" name="yesSmoke" @click="smoke(true)" style="background-color:#5B1A7C; border-color: #5B1A7C; " checked>네</button>
                    &nbsp;
                    <button class="btn btn-primary" type="button" name="noSmoke" @click="smoke(false)" style="background-color:#5B1A7C; border-color: #5B1A7C;">아니요</button>
                  </div>
                </div>
              </div>

                  <div v-if="SmokingFrequency">
                    <div class="form-group" style="margin-top:10%;">
                      <label>하루 기준 몇 갑(개비)을 피우시나요?</label>
                        <div class="form-check" style="margin-top:5%;">
                          <input class="form-check-input" type="radio" name="smokingAmount" value="5개비 이하" v-model="SmokingAmount" style="background-color:#5B1A7C; border-color: #5B1A7C;">
                          <label class="form-check-label" for="smokingAmount1">5개비 이하</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="smokingAmount" value="10개비 이하" v-model="SmokingAmount" style="background-color:#5B1A7C; border-color: #5B1A7C;" >
                          <label class="form-check-label" for="smokingAmount2">10개비 이하</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="smokingAmount" value="1갑 이상" v-model="SmokingAmount" style="background-color:#5B1A7C; border-color: #5B1A7C;">
                ...
                <div style="display:flex; justify-content:center; align-items:center; width:100%; height:100px; padding-inline: 25%; text-align: center; margin-top: 7%;">
                      <div style="width:100%; display:flex; padding-inline: 20%;">
                          <div style="width:40%; display:flex;">
                              <router-link :to="{ name: 'SecondCheck' }" type="submit" class="btn btn-primary" 
