        ...
        <form style="padding-inline: 30%;">
          ...
          <div style="padding-inline: 30%; margin-top:8%; font-size: larger; display:flex; justify-content:center; align-items:center;">
            <div class="form-group">
              <div>
                <button class="btn btn-primary" type="button" @click="smokeChecked(true)" style="background-color:#5B1A7C; border-color: #5B1A7C;" checked>네</button>
                &nbsp;
                <button class="btn btn-primary" type="button" @click="smokeChecked(false); SmokingAmount = true;" style="background-color:#5B1A7C; border-color: #5B1A7C;">아니요</button>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex; justify-content:center; align-items:center; width:100%; height:100px; padding-inline: 25%; text-align: center;">
            <div style="width:100%; display:flex; padding-inline: 20%;">
              <div style="width:40%; display:flex; ">
                <router-link :to="{ name: 'ThirdCheck' }" type="submit" class="btn btn-primary" 
                ...
                <div style="width:100%;">
                    <router-link v-if="SmokingAmount" :to="{ name: 'FifthCheck' }" type="submit" class="btn btn-primary" 
