        ...
        <form style="padding-inline: 30%;">
              <div>
                <div style="font-size: xx-large;">
                    <div style="margin-top:10%; display:flex; justify-content:center; align-items:center; font-weight: 100;">
                        <p style="margin-top:3%; font-weight: bold; ">음주</p>
                        를 하시나요?
                    </div>
                </div>
              </div>
              ...
              <div style="padding-inline: 30%; margin-top:8%; font-size: larger; display:flex; justify-content:center; align-items:center;">
                <div class="form-group">
                  <div>
                    <button class="btn btn-primary" type="button" name="yesDrink" @click="drinkChecked(true)" style="background-color:#5B1A7C; border-color: #5B1A7C;" checked>네</button>
                    &nbsp;
                    <button class="btn btn-primary" type="button" name="noDrink" @click="drinkChecked(false); DrinkingAmount = true;" style="background-color:#5B1A7C; border-color: #5B1A7C;">아니요</button>
                  </div>
                </div>
              </div>
