              ...
              <div>
                <div style="font-size: xx-large;">
                    <div style="margin-top:10%; height:100%; width:100%; display:flex; justify-content:start; align-items:center; font-weight: 100;">
                        <p style="margin-top:3%; font-weight: bold;">나이</p>
                        를 알려주세요.
                    </div>
                </div>
              </div>
                ...
                <div style=" margin-top:8%; font-size: larger;">
                    <div>
                        <select class="form-select" aria-label="Default select example" v-model="selectedOption">
                            ...
                            <option value="three">30 ~ 39세</option>
                            <option value="four">40 ~ 49세</option>
                            <option value="five">60세 이상</option>
                        </select>
                    </div>
                </div>
        ...
        <div style="display:flex; justify-content:center; align-items:center; width:100%; height:100px; padding-inline: 15%; text-align: center;">
            <div style="width:100%; display:flex; padding-inline: 20%;">
                <div style="width:40%; display:flex; ">
                    <router-link :to="{ name: 'FirstCheck' }" type="submit" class="btn btn-primary" 
                ...
                <div style="width:100%;">
                    <router-link v-if="selectedOption" :to="{ name: 'ThirdCheck' }" type="submit" class="btn btn-primary" 
